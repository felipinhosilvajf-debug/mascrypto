...
export default function Login() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#05040c] p-4">
      <div className="pointer-events-none absolute -left-40 -top-40 h-[520px] w-[520px] animate-[flutua_13s_ease-in-out_infinite] rounded-full bg-fuchsia-700/25 blur-[130px]" />
      <div className="pointer-events-none absolute -bottom-40 -right-32 h-[520px] w-[520px] animate-[flutua_17s_ease-in-out_infinite_reverse] rounded-full bg-cyan-600/20 blur-[130px]" />
      <div className="pointer-events-none absolute inset-0 opacity-[0.04] [background-image:linear-gradient(rgba(255,255,255,.8)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,.8)_1px,transparent_1px)] [background-size:56px_56px]" />
        ...
        <div className="flex flex-col justify-center gap-5 px-2">
          ...
          <div className="grid grid-cols-3 gap-2 text-sm sm:grid-cols-6">
            {[
              ...
              <div
                key={t}
                className="rounded-2xl border border-white/10 bg-white/[0.04] p-3 text-center transition hover:-translate-y-1 hover:border-fuchsia-400/40"
              >
                <div className="text-2xl">{e}</div>
                <div className="mt-1 text-[11px] font-bold text-slate-300">{t}</div>
              </div>
            ))}
          </div>
        </div>
